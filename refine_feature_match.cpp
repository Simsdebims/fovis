                        ...
                        float *delta_sse)
{
  ...
  ALIGN_DATA(16) uint8_t* ref_descriptor = (uint8_t*)_aligned_malloc(desc_stride * sizeof(uint8_t), 16);
  ...
  ALIGN_DATA(16) uint8_t* orig_target_desc = (uint8_t*)_aligned_malloc(desc_stride * sizeof(uint8_t), 16);
  target_level->populateDescriptorInterp(init_target_uv.x(), init_target_uv.y(),
                                         orig_target_desc);
  ALIGN_DATA(16) uint8_t* tgt_desc = (uint8_t*)_aligned_malloc(desc_stride * sizeof(uint8_t), 16);
  ...
  ALIGN_DATA(16) int16_t* pix_errs = (int16_t*)_aligned_malloc(buf_num_elements * sizeof(int16_t), 16);
  ...
  ALIGN_DATA(16) int16_t* ref_desc_dx = (int16_t*)_aligned_malloc(buf_num_elements * sizeof(int16_t), 16);
  ALIGN_DATA(16) int16_t* ref_desc_dy = (int16_t*)_aligned_malloc(buf_num_elements * sizeof(int16_t), 16);
  ...
  ALIGN_DATA(16) int16_t* Mx = (int16_t*)_aligned_malloc(buf_num_elements * sizeof(int16_t), 16);
  ALIGN_DATA(16) int16_t* My = (int16_t*)_aligned_malloc(buf_num_elements * sizeof(int16_t), 16);
  ...
  *delta_sse = final_sse - initial_sse;
  ...
  // Free the memory
  _aligned_free(ref_descriptor);
  _aligned_free(orig_target_desc);
  _aligned_free(tgt_desc);
  _aligned_free(pix_errs);
  _aligned_free(ref_desc_dx);
  _aligned_free(ref_desc_dy);
  _aligned_free(Mx);
  _aligned_free(My);
}
