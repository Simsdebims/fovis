 ...
 */
class FOVIS_EXPORT VisualOdometry
{
  public:
    /**
     ...
     */
    VisualOdometry(const CameraIntrinsicsParameters &params, const VisualOdometryOptions& options);
     ...
     */
	static void getDefaultOptions(VisualOdometryOptions* d_options);
  ...
  private:
    ...
    CameraIntrinsicsParameters _params;
};
